...
export default function WebhooksTab() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-[#13131f] rounded-xl border border-slate-100 dark:border-slate-800">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {statCards.map((card) => {
          ...
          return (
            <div
              key={card.label}
              className="bg-white dark:bg-[#13131f] p-4 rounded-xl border border-slate-100 dark:border-slate-800 hover:border-primary/30 hover:-translate-y-0.5 transition-all duration-250 group"
            >
      ...
      <div className="bg-white dark:bg-[#13131f] rounded-xl border border-slate-100 dark:border-slate-800 hover:border-primary/30 hover:-translate-y-0.5 transition-all duration-250 group">
